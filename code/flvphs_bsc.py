...
#Numbers in main: 1. site number (= link number), 2. coupling const, 3. mass1, 4. mass2, 5. penalty const, 6. boundary cond (0 = periodic, 1 = twisted), 7. number states eigenval 
print("Done!")